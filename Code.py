...
model = YOLO(r"C:\Users\KRISHNA\OneDrive\Desktop\runs\detect\train\weights\best.pt")
...
green_light_speech.save(r'C:\Users\KRISHNA\Downloads\greenlight.mp3')
    ...
    if success:
        ...
        if crosswalk_detected:
            ...
            if green_light_detected:
                playsound(r'C:\Users\KRISHNA\Downloads\greenlight.mp3')
